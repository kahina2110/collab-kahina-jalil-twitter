...
<nav class="bg-black border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class=" oho bg-[#FFBF84]  mt-[100px] border-6 border-black rounded-[50px] h-[30rem] w-[25rem] flex p-10 sm:justify-center ">
      ...
      <form id="login__form" class ="grid text-center " method="post">
        <h1 class="text-3xl font-style:Pactua One">Connexion</h1>
            <!-- <label>Pseudo</label> -->
            <input class="h-11 w-[20rem] rounded-full border-2 border-black pl-4" type="text" id="login__fields" name="nickname_email" placeholder="email or pseudo">
            <!-- <label>Email</label> -->
            
            <!-- <label>Password</label> -->
            <input  class="h-11 rounded-full border-2 border-black pl-4" type="password" id="login__fields" name="pass" placeholder="password">
            <button class="h-11 w-[8rem] ml-[100px] bg-[#d49a9a] rounded-full border-2 border-black hover:scale-75" type="submit" id="login__button">Sign in</button>
